<?php
/**
 * Página de Usuarios (Placeholder)
 * 
...
<div class="row">
    <div class="col-12">
        <div class="alert alert-info" role="alert">
            ...
            <p class="mb-0">La gestión completa de usuarios se implementará en las siguientes fases del proyecto. Por ahora, puedes usar el usuario administrador creado con seed_admin.php</p>
        </div>
    </div>
</div>
