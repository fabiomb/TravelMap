...
<div class="row">
    <div class="col-12">
        <h1 class="mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-speedometer2 me-2" viewBox="0 0 16 16">
                <path d="M8 4a.5.5 0 0 1 .5.5V6a.5.5 0 0 1-1 0V4.5A.5.5 0 0 1 8 4M3.732 5.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707M2 10a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 10m9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5m.754-4.246a.39.39 0 0 0-.527-.02L7.547 9.31a.91.91 0 1 0 1.302 1.258l3.434-4.297a.39.39 0 0 0-.029-.518z"/>
                <path fill-rule="evenodd" d="M0 10a8 8 0 1 1 16 0 8 8 0 0 1-16 0m8-7a7 7 0 0 0-2.204 13.616c.063.04.14.017.17-.047l.708-1.497c.027-.06.003-.13-.041-.17A5.48 5.48 0 0 1 4.5 10c0-3.038 2.462-5.5 5.5-5.5s5.5 2.462 5.5 5.5c0 1.862-.93 3.505-2.352 4.5-.044.039-.068.11-.041.17l.708 1.497c.03.064.107.087.17.047A7 7 0 0 0 8 3"/>
            </svg>
            Dashboard
        </h1>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h5 class="card-title text-muted mb-1">Total Viajes</h5>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h5 class="card-title text-muted mb-1">Públicos</h5>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h5 class="card-title text-muted mb-1">Puntos</h5>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h5 class="card-title text-muted mb-1">Usuarios</h5>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info border-0 mt-3" role="alert">
                    ...
                    <ul class="mb-0">
                        <li><a href="<?= BASE_URL ?>/admin/trips.php">Gestionar viajes</a> - Crea, edita o elimina viajes</li>
                        <li><a href="<?= BASE_URL ?>/admin/users.php">Gestionar usuarios</a> - Administra los usuarios del sistema</li>
                        <li><a href="<?= BASE_URL ?>/" target="_blank">Ver sitio público</a> - Visualiza cómo se ven tus viajes</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        Última actividad
                        <span class="badge bg-secondary rounded-pill">Ahora</span>
                    </li>
                </ul>
            </div>
        </div>
