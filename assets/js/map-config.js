/**
 * map-config.js
 * Shared map configuration: styles, transport types, point types, and utilities.
...
window.MapConfig = (function () {
    ...
    const RASTER_TILES = {
        ...
        'osm-liberty': 'https://tile.openstreetmap.org/{z}/{x}/{y}.png'
    };
    ...
    // Transport config — mutable so server settings can override colors (public_map.js)
    ...
    const pointTypeConfig = {
        'stay':  { icon: pointTypeIcons.stay,  color: '#FF6B6B', labelKey: 'map.point_type_stay' },
        'visit': { icon: pointTypeIcons.visit, color: '#4ECDC4', darkText: true, labelKey: 'map.point_type_visit' },
        'food':  { icon: pointTypeIcons.food,  color: '#FFE66D', darkText: true, labelKey: 'map.point_type_food' }
    };
    ...
    /** Wraps a bare GeoJSON geometry in a Feature if necessary. */
